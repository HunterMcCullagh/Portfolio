...
//Hunter McCullagh
//June 14/2020
//Compatible with DroneTransmitter3.0
...
void selfLevel(int input[4],int gyroX, int gyroY,int initalPower) //The self levelling function uses the angle of the gyroscope values to counteract the off balance of the drone
{
  input[1]=initalPower;
  input[2]=initalPower;
  input[3]=initalPower;
